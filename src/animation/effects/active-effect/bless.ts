...
adapter.autorec.register("bless", "token", "eskie.effect.bless.cast", DEFAULT_CONFIG, "0.0.1", "Bless");
adapter.autorec.register("bless", "effect", "eskie.effect.bless.effect", DEFAULT_CONFIG, "0.0.1", "Bless");