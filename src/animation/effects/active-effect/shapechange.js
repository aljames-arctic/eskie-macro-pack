...
async function createShapechange(token, config = {}) {
    ...
    sequence
        ...
        .animateProperty('spriteContainer', 'width', { from: 0, to: 0.25 * token.document.texture.scaleX, duration: 500, gridUnits: true, ease: 'easeOutCubic', delay: 2600 })
        .animateProperty('spriteContainer', 'height', { from: 0, to: 0.25 * token.document.texture.scaleX, duration: 500, gridUnits: true, ease: 'easeOutCubic', delay: 2600 })
        .belowTokens()
        ...
        .animateProperty('spriteContainer', 'width', { from: (token.document.width * 1.1) * token.document.texture.scaleX, to: (token.document.width * 1.25) * token.document.texture.scaleX, duration: 500, gridUnits: true, ease: 'easeInOutBack' })
        .animateProperty('spriteContainer', 'height', { from: (token.document.width) * token.document.texture.scaleX, to: (token.document.width * 1.25) * token.document.texture.scaleX, duration: 750, gridUnits: true, ease: 'easeOutBack' })
