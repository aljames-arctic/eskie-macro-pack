...
async function create(token, target, config = {}) {
    ...
    let seq = new Sequence()
        ...
        .effect()
            ...
            .scaleToObject(1.75)
            .fadeIn(500)
            .animateProperty('spriteContainer', "width", { from: 0, to: -1, duration: 1500, gridUnits:true, ease: "easeOutCubic"})
            .animateProperty('spriteContainer', "height", { from: 0, to: -1, duration: 1500, gridUnits:true, ease: "easeOutCubic"})
            .startTime(5500)
            .zIndex(1)
