...
async function create(token, target, config = {}) {
    ...
    .effect()
        ...
        .animateProperty('spriteContainer', "rotation", { from: 0, to: 45, duration: 150, ease:"easeOutCubic", delay: 1300})
        .animateProperty('spriteContainer', "rotation", { from: 0, to: -45, duration: 350, ease:"easeOutBack", delay: 1450})
