...
async function create(token, target, config = {}) {
    ...
    sequence.effect()
        ...
        .animateProperty('spriteContainer', "width", { from: 0.8, to: 0.25, duration: 500, gridUnits: true, ease: "easeOutBack", delay: 1500 })
        .animateProperty('spriteContainer', "height", { from: 1, to: 0.25, duration: 500, gridUnits: true, ease: "easeOutBack", delay: 1500 })
