...
async function create(token, target, config = {}) {
    ...
    .effect()
        ...
        .animateProperty('spriteContainer', "rotation", { from: 0, to: 360, duration: 1000, ease: "easeOutCubic" })
        .animateProperty("spriteContainer", "position.x", { from: -0.2, to: 0.25, duration: 1500, gridUnits: true, ease: "easeOutBack", delay: 1500 })
        .animateProperty('spriteContainer', "rotation", { from: 0, to: 360, duration: 4042, ease: "easeOutSine" })
        .fadeOut(750)
        .zIndex(1)
