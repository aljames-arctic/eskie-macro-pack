...
async function createHarvest(token, target, config = {}) {
    ...
    seq.effect()
        ...
        .animateProperty('spriteContainer', 'position.y', { from: 0, to: -0.25, duration: 250, ease: 'easeOutSine', gridUnits: true, delay: 1000 })
        .animateProperty('spriteContainer', 'position.y', { from: 0, to: 0.55, duration: 1250, ease: 'easeOutSine', gridUnits: true, delay: 1250 })
