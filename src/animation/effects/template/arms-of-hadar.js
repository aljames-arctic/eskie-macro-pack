...
async function create(token, config = {}) {
    ...
    sequence
        ...
        .animateProperty('spriteContainer', "width", { from: 5.5, to: 0, duration: 1500, delay: 1000, gridUnits: true, ease: "easeOutCirc" })
        .animateProperty('spriteContainer', "height", { from: 5.5, to: 0, duration: 1500, delay: 1000, gridUnits: true, ease: "easeOutCirc" })
        .fadeOut(500)
