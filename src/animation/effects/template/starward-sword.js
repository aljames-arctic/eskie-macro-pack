...
async function createStarwardSword(token, config = {}, options = {}) {
    ...
    mainSequence
        ...
        .animateProperty('spriteContainer', "width", { from: 1, to: 0.025, duration: 300, ease: "easeOutCubic", gridUnits: true })
        .animateProperty('spriteContainer', "height", { from: 1, to: 1.5, duration: 300, ease: "easeOutCubic", gridUnits: true })
        .fadeOut(200)
        .duration(400)
                ...
                .thenDo(function () {
                    targets.forEach(target => {
                        new Sequence()
                            ...
                            .animateProperty('spriteContainer', "rotation", { from: 0, to: 90, duration: 500, ease: "easeInOutBack" })
