...
async function create(token, config = {}) {
    ...
    seq.wait(100)
        ...
        .effect()
            ...
            .spriteRotation(45)
            .zIndex(6)
            .animateProperty('spriteContainer', "height", {from:1, to: 1.5,  duration: 1000, gridUnits: true, ease:"easeOutCubic"})
        ...
        .effect()
            ...
            .animateProperty('spriteContainer', "width", {from: 0, to: -0.15,  duration: upTime, gridUnits: true,delay: 200})
            .animateProperty('spriteContainer', "width", {from: 0, to: 0.15,  duration: downTime, gridUnits: true, delay: upTime+200})
            .animateProperty('spriteContainer', "height", {from: 0, to: -0.15,  duration: upTime, gridUnits: true,delay: 200})
            .animateProperty('spriteContainer', "height", {from: 0, to: 0.15,  duration: downTime, gridUnits: true, delay: upTime+200})
        ...
        .effect()
            ...
            .duration(jumpTime+200)
            .animateProperty('spriteContainer', "rotation", { from: 0, to: 360, duration: upTime+downTime,ease:"easeInSine", delay:200})
            .zIndex(5)
