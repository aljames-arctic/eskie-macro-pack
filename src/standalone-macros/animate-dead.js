...
sequence
    ...
    .effect()
        ...
        .file(closest("jb2a.magic_signs.circle.02.necromancy.intro.dark_purple"))
    ...
    .effect()
        ...
        .delay(2250)
        .atLocation(targetLocation)
        .file(closest("jb2a.magic_signs.circle.02.necromancy.loop.dark_purple"))
        .size(1.5, { gridUnits: true })
        .belowTokens(true)
    ...
    .effect()
        .name(label)
        .delay(150)
        .file(closest("jb2a.impact.ground_crack.01.brown"))
        .atLocation(targetLocation)
