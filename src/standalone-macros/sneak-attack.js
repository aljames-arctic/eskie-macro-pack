...
for (const target of targets) {
    ...
    if (useMelee) {
        ...
        sequence.effect()
            .name(label)
            .delay(150)
            .file(closest(`jb2a.impact.007.${meleeColorImpact}`))
        ...
        sequence.effect()
            .name(label)
            .delay(150)
            .file(closest(`jb2a.liquid.splash_side02.${meleeColorDamage}`))
            .atLocation(targetSquare)
        ...
        sequence.effect()
            .name(label)
            .delay(150)
            .file(closest(`jb2a.impact.007.${rangedColorImpact}`))
            .size(1.25 * tokenWidth, { gridUnits: true })
            .atLocation(target)
            .randomRotation()
            .playbackRate(0.9)
        ...
        sequence.effect()
            .name(label)
            .delay(150)
            .file(closest(`jb2a.liquid.splash_side02.${rangedColorDamage}`))
            .atLocation(target)
            .size(1.5 * tokenWidth, { gridUnits: true })
            .rotateTowards(token)
            .spriteOffset({ x: -1.15 * tokenWidth }, { gridUnits: true })
